...
2. Plot the likelihood surface for $b_0$ and $b_1$ and indicate the MLEs your likelihood surface. 
3. Obtain confidence intervals for your estimates. 
4. Finally plot your data with the fitted line.
...
5. Use the _optim_ function to find the MLEs of all of your parameters.
6. Plot the fitted function with the data and your fittend line from Task 1.
