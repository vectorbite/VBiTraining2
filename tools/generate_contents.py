"""
Generate a markdown table of contents for use in the Index.ipynb or elsewhere 
...
if __name__ == '__main__':
    print_contents()
    print('\n', 70 * '#', '\n')
    print_contents('https://nbviewer.jupyter.org/github/vectorbite/VBiTraining/tree/master/notebooks/')
